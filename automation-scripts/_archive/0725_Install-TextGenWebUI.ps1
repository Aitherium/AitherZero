...
Ensure-FeatureEnabled -Section "Features" -Key "AI.TextGenWebUI" -Name "TextGenWebUI"

# Resolve Configuration
if ([string]::IsNullOrWhiteSpace($InstallPath)) {
    $configPath = Get-AitherConfigs -Section "Features" -Key "AI.TextGenWebUI.InstallPath" -ErrorAction SilentlyContinue
    if ($configPath) {
