...
try {
    ...
    if ($config.Features.Infrastructure -and $config.Features.Infrastructure.PXE) {
        $pxeConfig = $config.Features.Infrastructure.PXE
        $shouldConfigure = $pxeConfig.Enabled -eq $true
    }
