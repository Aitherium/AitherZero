...
**Pros:**
- [OK] Fastest and simplest method
- [OK] One command from PR
- [OK] Automatic version file updates
...
**Pros:**
- [OK] Full control over commit message
- [OK] Works from any branch
- [OK] Can be scripted
...
1. [OK] All tests passing on main branch
2. [OK] Code quality checks passing (PSScriptAnalyzer)
3. [OK] Documentation up to date
4. [OK] CHANGELOG updated (use `./library/automation-scripts/0798_generate-changelog.ps1`)
5. [OK] VERSION file updated
6. [OK] Module manifest version updated (AitherZero.psd1)
...
1. [OK] Run pre-release validation
2. [OK] Build release packages (ZIP, TAR.GZ)
3. [OK] Generate build info and release notes
4. [OK] Create GitHub Release
5. [OK] Upload release assets
6. [OK] Update `latest` tag (for stable releases)

The `docker-publish.yml` workflow will automatically:

1. [OK] Build Docker images for linux/amd64 and linux/arm64
2. [OK] Push images to GitHub Container Registry (ghcr.io)
3. [OK] Tag images appropriately (version, latest, sha)
4. [OK] Run security scan with Trivy
5. [OK] Test image functionality
...
$url = "https://github.com/Aitherium/AitherZero/releases/download/v1.1.0/AitherZero-v1.1.0.zip"
...
- Open an issue: https://github.com/Aitherium/AitherZero/issues
- Start a discussion: https://github.com/Aitherium/AitherZero/discussions
