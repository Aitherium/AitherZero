...
- [NEW] New Features (feat)
- [BUG] Bug Fixes (fix)
- Documentation (docs)
- Style (style)
- Code Refactoring (refactor)
- [FAST] Performance (perf)
- [OK] Tests (test)
...
- [X] **Before**: Both workflows triggered on tag push, causing duplicate Docker builds
- [OK] **After**: Sequential execution - tag push → release creation → Docker build
