...
Ensure-FeatureEnabled -Section "Features" -Key "AI.SillyTavern" -Name "SillyTavern"

# Resolve Configuration
if ([string]::IsNullOrWhiteSpace($InstallPath)) {
    $configPath = Get-AitherConfigs -Section "Features" -Key "AI.SillyTavern.InstallPath" -ErrorAction SilentlyContinue
    if ($configPath) {
