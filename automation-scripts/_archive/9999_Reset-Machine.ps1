...
try {
    ...
    if ($config.Features.Maintenance -and $config.Features.Maintenance.MachineReset) {
        $machineResetConfig = $config.Features.Maintenance.MachineReset
        $shouldReset = $machineResetConfig.Enabled -eq $true
