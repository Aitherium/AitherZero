...
try {
    ...
    if ($config.Features.Infrastructure -and $config.Features.Infrastructure.Directories -and $config.Features.Infrastructure.Directories.Configuration) {
        $dirs = $config.Features.Infrastructure.Directories.Configuration
