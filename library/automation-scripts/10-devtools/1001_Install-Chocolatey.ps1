...
try {
    ...
    if ($config.Features.DevTools -and $config.Features.DevTools.Chocolatey) {
        $chocoConfig = $config.Features.DevTools.Chocolatey
        $shouldInstall = $chocoConfig.Enabled -eq $true
    }
