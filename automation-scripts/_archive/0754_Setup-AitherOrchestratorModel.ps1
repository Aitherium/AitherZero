...
.DESCRIPTION
    Creates the aither-orchestrator-8b-v4 model from the custom Modelfile.
    This model builds on top of nvidia-orchestrator with AitherOS-specific:
...
# Configuration
$ModelName = "aither-orchestrator-8b-$ModelVersion"
$ModelDisplayName = "Aither Orchestrator 8B $($ModelVersion.ToUpper())"
...
$ModelfilePath = Join-Path $RepoRoot "AitherOS/Library/Models/aither-orchestrator-8b-$ModelVersion.Modelfile"
$ModelsDir = Join-Path $RepoRoot "AitherOS/Library/Models"
