...
# [OK] AitherZero loaded. Type AitherZero Bootstrap to begin.
...
# Run a playbook
docker exec aitherzero-test pwsh -Command "Invoke-AitherPlaybook -Name test-quick"
```
...
# Full test playbook
docker exec aitherzero-test pwsh -Command \
 "Invoke-AitherPlaybook -Name test-full"
```
...
- [OK] `az 0402` - Unit tests
- [OK] `az 0404` - PSScriptAnalyzer
- [OK] `az 0407` - Syntax validation
- [OK] `az 0510` - Generate reports
- [OK] `AitherZero Bootstrap` - Interactive menu

**What requires a full environment:**
- [X] Infrastructure deployment (0300-0399 range)
- [X] Hyper-V setup (requires Windows host)
