...
.EXAMPLE
    .\0707_Setup-GitHubRunner.ps1 -Repository "myorg/myrepo" -ShowOutput
    Sets up a GPU runner with default settings.

.EXAMPLE
    .\0707_Setup-GitHubRunner.ps1 -Repository "myorg/myrepo" -RunnerName "beast-gpu" -Labels @("a6000", "48gb") -ShowOutput
...
try {
    ...
    Write-Status "Runner setup failed: $_" -Type "ERROR"
    $script:ExitCode = 1
}
