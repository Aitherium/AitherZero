...
- [OK] Reduces time agents spend exploring codebase
- [OK] Prevents common build/test failures
- [OK] Documents exact command sequences that work
- [OK] Captures timing expectations for long operations
- [OK] Lists known issues to ignore
- [OK] Provides troubleshooting for common errors
- [OK] Establishes quality standards upfront
