...
try {
    ...
    $shouldInstall = $false
    if ($config.Features.Infrastructure -and $config.Features.Infrastructure.HyperV) {
        $hyperVConfig = $config.Features.Infrastructure.HyperV
        $shouldInstall = $hyperVConfig.Enabled -eq $true
    }
    ...
    if ($config.Features.Infrastructure.HyperV.Configuration.PrepareHost -eq $true) {
        ...
        try {
            ...
            if ($config.Features.Infrastructure.HyperV.Configuration.DefaultVMPath) {
                $vmPath = [System.Environment]::ExpandEnvironmentVariables($config.Features.Infrastructure.HyperV.Configuration.DefaultVMPath)
            ...
            if ($config.Features.Infrastructure.HyperV.Configuration.DefaultVHDPath) {
                $vhdPath = [System.Environment]::ExpandEnvironmentVariables($config.Features.Infrastructure.HyperV.Configuration.DefaultVHDPath)
