...
```
AitherZero Core
 CLI (bootstrap.ps1 -Mode New -Playbook genesis-bootstrap)
...
# Or via CLI
./bootstrap.ps1 -Mode New -Playbook genesis-bootstrap -Mode MyExtensionMode -Target "example"
```
...
Usage:
```bash
./bootstrap.ps1 -Mode New -Playbook genesis-bootstrap -Mode Deploy -Target myapp -Environment production
```
...
Usage:
```bash
./bootstrap.ps1 -Mode New -Playbook genesis-bootstrap -Mode Run -Target 8100
```
