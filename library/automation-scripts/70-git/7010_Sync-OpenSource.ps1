...
# $PSScriptRoot is .../library/automation-scripts/70-git/
# We need to go up 3 levels to reach the AitherZero root
$AitherZeroRoot = Split-Path $PSScriptRoot -Parent | Split-Path -Parent | Split-Path -Parent
