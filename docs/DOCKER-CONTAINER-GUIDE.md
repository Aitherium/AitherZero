...
PS /opt/aitherzero> AitherZero Bootstrap
```
...
PS /opt/aitherzero> AitherZero Bootstrap # Launch interactive menu
...
docker run --rm \
 -e AITHERZERO_CI=true \
 ghcr.io/wizzense/aitherzero:pr-1634 \
 pwsh -Command "Invoke-AitherPlaybook -Name test-full -NonInteractive"
...
- [OK] Testing (`az 0402`)
- [OK] Linting (`az 0404`)
- [OK] Validation (`az 0407`)
- [OK] Reports (`az 0510`)
- [OK] Interactive menu (`AitherZero Bootstrap`)

**Requires full environment:**
- [X] Infrastructure deployment (0300-0399)
- [X] Hyper-V setup (Windows only)
- [X] Some platform-specific features
...
docker run --rm ghcr.io/wizzense/aitherzero:latest \
 pwsh -Command "./bootstrap.ps1 -Mode New -Playbook genesis-bootstrap -Mode Validate"
...
2. Review [GitHub Issues](https://github.com/Aitherium/AitherZero/issues)
