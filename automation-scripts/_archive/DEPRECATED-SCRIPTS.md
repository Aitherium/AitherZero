...
|--------|--------|-------------|
| `0409_Run-AllTests.ps1` | [WARN] DEPRECATED | `0962_Run-Playbook.ps1 -Playbook test-orchestrated -Profile full` |
| `0460_Orchestrate-Tests.ps1` | [WARN] DEPRECATED | `0962_Run-Playbook.ps1 -Playbook test-orchestrated` |
| `0470_Orchestrate-SimpleTesting.ps1` | [WARN] DEPRECATED | `0962_Run-Playbook.ps1 -Playbook test-orchestrated -Profile quick` |
| `0480_Test-Simple.ps1` | [WARN] DEPRECATED | `0962_Run-Playbook.ps1 -Playbook test-orchestrated -Profile quick` |
| `0490_AI-TestRunner.ps1` | [WARN] DEPRECATED | `0962_Run-Playbook.ps1 -Playbook test-orchestrated` |
