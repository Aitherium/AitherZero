...
**Checks:**
- [OK] Presence of try/catch blocks around risky operations
- [OK] `$ErrorActionPreference = 'Stop'` is set
- [OK] Proper error logging in catch blocks
- [OK] Finally blocks for cleanup operations
- [OK] Error handling for common risky operations:
...
**Checks:**
- [OK] Presence of logging statements
- [OK] Use of appropriate logging functions (`Write-CustomLog`, `Write-Verbose`, etc.)
- [OK] Logging at different levels (Information, Warning, Error)
- [OK] Logging of important operations
- [OK] Function-level logging
...
**Checks:**
- [OK] Existence of corresponding test file (`.Tests.ps1`)
- [OK] Test file is in appropriate location:
...
- [OK] Adequate number of test cases (minimum 3 recommended)
- [OK] Valid test file syntax
- [OK] Use of Pester testing framework
...
**Checks:**
- [OK] Presence of `[CmdletBinding()]` for advanced parameter support
- [OK] Properly defined parameters with `[Parameter()]` attribute
- [OK] Comment-based help documentation:
 - `.SYNOPSIS` - Brief description
 - `.DESCRIPTION` - Detailed description
 - `.PARAMETER` - Parameter descriptions
 - `.EXAMPLE` - Usage examples
- [OK] Integration into launcher (`bootstrap.ps1 -Mode New -Playbook genesis-bootstrap`) for automation scripts
...
**Checks:**
- [OK] Testing and validation scripts (040x, 050x) are referenced in workflows
- [OK] Quality and reporting scripts are integrated appropriately
- [OK] Automation scripts are callable from CI/CD pipeline
...
**Checks:**
- [OK] No PSScriptAnalyzer errors
- [OK] Minimal PSScriptAnalyzer warnings
- [OK] Compliance with PSScriptAnalyzer rules defined in `PSScriptAnalyzerSettings.psd1`
...
# Or with AitherZero Bootstrap
./bootstrap.ps1 -Mode New -Playbook genesis-bootstrap -Mode Orchestrate -Sequence 0420
```
