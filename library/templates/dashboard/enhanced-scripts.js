...
function createGitHubIssue(template = 'bug') {
    ...
    const url = `https://github.com/Aitherium/AitherZero/issues/new?` +
...
function createPullRequest() {
    const url = 'https://github.com/Aitherium/AitherZero/compare';
    window.open(url, '_blank');
}

function openDocumentation(section = '') {
    const url = section 
        ? `https://github.com/Aitherium/AitherZero/tree/main/docs/${section}`
        : 'https://github.com/Aitherium/AitherZero/tree/main/docs';
    window.open(url, '_blank');
}
...
function navigateToIndex(path) {
    const url = `https://github.com/Aitherium/AitherZero/blob/main/${path}`;
    window.open(url, '_blank');
}
