...
> [WARN] **Important**: Infrastructure definitions are managed as Git submodules, not stored directly in this directory. See [SUBMODULES.md](./SUBMODULES.md) for complete documentation on the submodule system.
...
### [FILES] Legacy Directory Structure (Deprecated)
